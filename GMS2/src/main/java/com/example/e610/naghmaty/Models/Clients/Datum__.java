...
public class Datum__ implements Parcelable
{
    ...
    public final static Creator<Datum__> CREATOR = new Creator<Datum__>() {
     ...
     * @param arDescription
     */
    public Datum__(Integer id, String arName, String enName, String arDescription, String enDescription, String logo, List<Object> images) {
        super();
        this.id = id;
        this.arName = arName;
        this.enName = enName;
