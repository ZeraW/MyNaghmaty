...
import com.example.e610.naghmaty.Activities.AboutUsActivity;
...
public class ViewPagerFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(!imgUrl.contains("e610")) {
            ...
            if(pageNum==0) {
                Picasso.with(getActivity()).load(R.drawable.placeholder).placeholder(R.drawable.facebook)
                        .error(R.drawable.facebook).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).fit().centerInside().into(imageView);
            }else if(pageNum==1) {
                Picasso.with(getActivity()).load(R.drawable.placeholder).placeholder(R.drawable.facebook)
                        .error(R.drawable.facebook).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).fit().centerInside().into(imageView);
            }else if(pageNum==2) {
